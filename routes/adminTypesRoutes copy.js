...
router.get('/:id', auth.authorize('can_view_detail', TABLE_NAME), adminTypesController.getAdminTypeById);
router.post('/', auth.authorize('can_add', TABLE_NAME), adminTypeValidationRules, validate, adminTypesController.createAdminType);
router.put('/:id', auth.authorize('can_update', TABLE_NAME), adminTypeUpdateValidationRules, validate, adminTypesController.updateAdminType);
