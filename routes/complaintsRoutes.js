...
const { userValidationRules, validate } = require('../validators/complaintsValidator');
...
router.post('/', upload.single('complaint_images'), userValidationRules, validate, complaintsController.createComplaint);
